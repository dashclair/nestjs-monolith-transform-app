...
export class AddLoginFieldsAndVerificationPurpose1788981276699 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."email_verifications_purpose_enum" AS ENUM('register', 'login')`,
    );
    await queryRunner.query(
      `ALTER TABLE "email_verifications" ADD "purpose" "public"."email_verifications_purpose_enum" NOT NULL DEFAULT 'register'`,
    );
    await queryRunner.query(
