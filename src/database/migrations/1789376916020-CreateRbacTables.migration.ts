...
export class CreateRbacTables1789376916020 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_f3c72eb82c0df496fe860380c3" ON "grants" ("roleId", "permissionId") `);
        await queryRunner.query(`ALTER TABLE "grants" ADD CONSTRAINT "FK_97768f55378cee5140b026d8140" FOREIGN KEY ("roleId") REFERENCES "roles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "grants" ADD CONSTRAINT "FK_3a08b3fe17aa7245eaafca4007d" FOREIGN KEY ("permissionId") REFERENCES "permissions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
   ...
   SELECT r.id, p.id FROM "roles" r, "permissions" p WHERE r.name = 'admin' AND p.name = 'rbac'`,
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "grants" DROP CONSTRAINT "FK_3a08b3fe17aa7245eaafca4007d"`);
        await queryRunner.query(`ALTER TABLE "grants" DROP CONSTRAINT "FK_97768f55378cee5140b026d8140"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f3c72eb82c0df496fe860380c3"`);
